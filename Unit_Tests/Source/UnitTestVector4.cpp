...
namespace UnitTest
{
    const bool TestUnitOperatorVector4()
    {
        ...
        // Operator +=
        Math::Vector4 vector4 = Math::Vector4(1.f, 1.f, 1.f, 1.f);
        ...
        // Operator /=
        vector4 = Math::Vector4(2.f, 2.f, 2.f, 2.f);
        vector4 /= 2.f;
    ...
    {
        Math::Vector4 v1(1.f, 4.f, 8.f, 1.f);
        Math::Vector4 v2(2.f, 3.f, 7.f, 1.f);
        glm::vec4 v3(1.f, 4.f, 8.f, 1.f);
        glm::vec4 v4(2.f, 3.f, 7.f, 1.f);

        const float myResult = Math::Vector4::DotProduct(v1, v2);
    ...
    const bool TestUnitMagnitudeVector4()
    {
        ...
        const float myResult = Math::Vector4::Magnitude(v1);
    ...
    {
        Math::Vector4 v1(1.f, 4.f, 9.f, 1.f);
        glm::vec4 v2(1.f, 4.f, 9.f, 1.f);

        const Math::Vector4 myResult = Math::Vector4::Normalize(v1);
    ...
    {
        Math::Vector4 v1(4.f, 4.f, 4.f, 2.f);
        v1 = Math::Vector4::Homogenize(v1);
